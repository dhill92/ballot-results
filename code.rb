...
precinct_two_sum = 0
vote_results[1].each do |votes|
  precinct_two_sum += votes
end

puts "Precinct 1 had #{precinct_one_sum} votes"

puts "Precinct 2 had #{precinct_two_sum} votes"
puts ""
...
vote_results.size.times do |precinct_index|
  ...
  billy_joe_votes += vote_results[precinct_index][1]
  sally_jane_votes += vote_results[precinct_index][2]
end
puts ""
